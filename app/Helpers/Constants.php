...
const LENGTH_DEFAULT_TEXT = 100;
const LENGTH_DEFAULT_SHOP_ADDRESS = 200;
const LENGTH_DEFAULT_CATEGORY_NAME = 30;
...
const TELEGRAM_SHOP_IMAGES_EXTENSION = 'jpg';
const TELEGRAM_SHOP_IMAGES_FINAL_WIDTH = 450;
const TELEGRAM_SHOP_IMAGES_FINAL_HEIGHT = 450;
const TELEGRAM_SHOP_IMAGES_FINAL_QUALITY = 80;

const CATEGORY_COUNT_MAX = 15;
const PAGINATION_LISTS_CATEGORY = 5;
const PAGINATION_LISTS_PRODUCT = 5;

const PRODUCT_COUNT_MAX = 100;
const PRODUCT_ITEM_COUNT_MAX = 5;
const PRODUCT_WITHOUT_CATEGORY_TITLE = 'بدون دسته بندی';
